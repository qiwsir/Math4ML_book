...
>
> $$\text{lim}_{x\rightarrow\infty}a_n=L$$
...
- 趋近无穷大，即：$$\text{lim}_{x\to\infty}a_n=\infty$$

**收敛极限的基本性质**

若 $$\text{lim}_{n\to\infty}a_n=\alpha,\text{lim}_{n\to\infty}b_n=\beta$$ ，及 $$c\in\mathbb{R}$$ ，则：

- 相加：$$\text{lim}_{n\to\infty}(a_n\pm b_n)=\text{lim}_{n\to\infty}a_n\pm\text{lim}_{n\to\infty}b_n=\alpha\pm\beta$$
- 常倍数：$$\text{lim}_{n\to\infty}c\cdot a_n=c\cdot\text{lim}_{n\to\infty}a_n=c\cdot\alpha$$
- 相乘：$$\text{lim}_{n\to\infty}(a_n\cdot b_n)=\text{lim}_{n\to\infty}a_n\cdot\text{lim}_{n\to\infty}b_n=\alpha\cdot\beta$$
- 相除：$$\text{lim}_{n\to\infty}\frac{a_n}{b_n}=\frac{\text{lim}_{n\to\infty}a_n}{\text{lim}_{n\to\infty}b_n}=\frac{\alpha}{\beta},(\beta\ne0)$$
...
> 且
>
> $$\text{lim}_{n\to\infty}a_n=\text{lim}_{n\to\infty}c_n=L$$
>
> 则有：
>
> $$\text{lim}_{n\to\infty}b_n=L$$

举例：

- 求极限 $$\text{lim}_{n\to\infty}\frac{n!}{n^n}$$
  ...
  由于 $$\text{lim}_{n\to\infty}0=0=\text{lim}_{n\to\infty}\frac{1}{n}$$

  由“夹逼定理”得：$$\text{lim}_{n\to\infty}\frac{n!}{n^n}=0$$

- 求极限 $$\text{lim}_{n\to\infty}\frac{\sin(n)}{n}$$
...
- 求极限 $$\text{lim}_{n\to\infty}\left(\frac{1}{\sqrt{n^2+1}}+\frac{1}{\sqrt{n^2+2}}+\cdots+\frac{1}{\sqrt{n^2+n}}\right)$$
